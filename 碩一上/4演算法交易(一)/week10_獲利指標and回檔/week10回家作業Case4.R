...
library(dplyr)
library(quantmod)
data1<-read_csv("C:/Users/Peter/Desktop/data1.csv")
data2<-read_csv("C:/Users/Peter/Desktop/data2.csv")
data<-data.frame(Capital1=data1$Capital,
                 Capital2=data2$Capital)
data$Capital=data$Capital1+data$Capital2
###絕對回檔drawdown
...
mtext("PL1+PL2",3,line=1,cex=1.3)
